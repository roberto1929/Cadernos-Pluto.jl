...
# ╔═╡ 80f7df47-816c-490f-a478-37d9204db8c8
using PlutoUI, Plots, Printf, PlotlyBase

# ╔═╡ 56bf7b80-4850-11ef-2b4b-d10f2184cd7f
md"""
# Exercícios em Julia: Linhas de Transmissão
...
# ╔═╡ 0d2012c8-3f37-47ba-a5c3-1892d8884795
md"""
...
Usando propriedades dos números complexos, podemos simplificar isso para: $V_\textit{sT}(z) = 2 V_0~\cos(\beta z)$
"""

# ╔═╡ e7c71538-5066-4930-adf3-169e69ab6de1
md"""
...
# ╔═╡ e9e7a36e-8d94-496a-a67d-7e366d98769d
md"""
### Demonstração do gráfico de onda estácionária
"""

# ╔═╡ cc1e4a91-a233-46e9-a8a8-d0f635128528
# ╠═╡ show_logs = false
plotly()

# ╔═╡ 5b6be4ca-4776-4aee-b7a0-e96da20d6665
@bind z_min Slider(-50:1:0, show_value=true, default=-10)

# ╔═╡ f1567a57-1d45-45d7-99f9-520e203064a8
z_min

# ╔═╡ a6f54318-278c-4e0e-bd08-90b3baf4bf98
@bind z_max Slider(0:1:50, show_value=true, default=10)

# ╔═╡ 2e9d3c68-f160-41b1-be31-73379d0ed1e5
z_max

# ╔═╡ 43a52b04-d0fc-4083-bd5e-e7c1c8718033
@bind t_min Slider(0:0.1:2π, show_value=true, default=0)

# ╔═╡ df4216d8-fd87-4cc3-86c3-83e6f5a3bc14
t_min

# ╔═╡ d02eeb7b-1626-49a1-b4d9-442ae3a239fd
@bind t_max Slider(2π:0.1:4π, show_value=true, default=2π)

# ╔═╡ 71d0eb19-c982-46b8-9f97-1033fe6374fc
t_max

# ╔═╡ 52a668f6-6a7c-4089-9ce1-77357783da98
md"""
#### Gráfico gerado da tensão total: 
"""

# ╔═╡ 70a5806d-9a26-4585-b244-c520a3c42cb6
let
...
# Definir os vetores de posição (z) e tempo (t) usando sliders
z = LinRange(z_min, z_max, 200)   # 200 pontos de z_min a z_max
t = LinRange(t_min, t_max, 200)   # 200 pontos de t_min a t_max
...
# ╔═╡ 26ac3b67-3458-4430-b6f7-9f131a2b3089
let
# Definir constantes
V0 = 1.0       # Amplitude da onda
omega = 2.0    # Frequência angular (rad/s)
...
# ╔═╡ cdb665c7-95af-4f8a-a21f-cf627212ee08
let
...
plot(t, V_t_fixo, xlabel="Tempo (t)", ylabel="Tensão (V)", title="Corte para Posição Fixa (z = $(z_fixo))")
end

# ╔═╡ 6f3f5208-ad9e-4429-9698-98190b6f190e
md"""
#### Gráfico gerado do corte da onda para um valor fixo de tempo:
"""

# ╔═╡ 4a8fa7a8-6ab1-47eb-ae2d-2a6d15dfc35c
let 
...
# Definir os vetores de posição (z) e tempo (t)
z = LinRange(z_min, z_max, 200)   # 200 pontos de z_min a z_max
t_fixo = π / 2.0             # Tempo fixo
V_z_fixo = [V_total(zi, t_fixo) for zi in z]

# Plot do corte para um valor fixo de tempo
plot(z, V_z_fixo, xlabel="Posição (z)", ylabel="Tensão (V)", title="Corte para Tempo Fixo (t = $(t_fixo))")
end

# ╔═╡ 85cbde5f-46cc-4dde-bbd5-5e9f878287a3
md"""
## Exemplo 10.2
...
# ╔═╡ bfbe3d5d-8db0-4bd0-b0a7-b4705ab446d0
let
...
# ╔═╡ 3766cde4-b851-4a49-9c58-f7d676de03fb
md"""
## Exemplo 10.3
...
# ╔═╡ 7113f659-1da8-4db1-92e8-891f46a09f1c
let
...
manifest_format = "2.0"
project_hash = "2beb0fe81538ad7c82f6b6b919be0f95e183a91b"
